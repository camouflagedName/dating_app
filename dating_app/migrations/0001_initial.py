    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_puzzle', to=settings.AUTH_USER_MODEL)),
                ('questions', models.ManyToManyField(to='dating_app.puzzle_question')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viewer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='puzzles_accessed', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.AddField(
            model_name='user',
            name='puzzles_solved',
            field=models.ManyToManyField(related_name='solver', to='dating_app.puzzle_instance'),
        ),
        migrations.AddField(
            model_name='user',
