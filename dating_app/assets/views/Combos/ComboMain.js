...
export const ComboMain = props => {
    ...
    useEffect(() => {
        ...
        if (props.default === true) {
            ...
            const editInput = new ComboConstructor(userData.private.comboData[0].data, visible)
    ...
    return (
        <>
            ...
            <h1 className="text-center mb-5">{props.solve ? `Complete ${props.comboData.creator}'s` : props.edit === true ? "Edit Your" : "Build Your"} Combo</h1>
